...
export class Repository {
    ...
    get Work() {
        if (!this.#work)
            throw new Error("work is undefined");
        return this.#work;
    }
    #profile;
    get Profile() {
    ...
    get ProfileAvatar() {
        if (!this.#profileAvatar)
            throw new Error("profileAvatar is undefined");
        return this.#profileAvatar;
    }
    #workResp;
    get WorkResp() {
        if (!this.#workResp)
            throw new Error("workResp is undefined");
        return this.#workResp;
    }
    #workRespLike;
    get WorkRespLike() {
        if (!this.#workRespLike)
            throw new Error("workRespLike is undefined");
        return this.#workRespLike;
    }
    #workTopic;
    get WorkTopic() {
        if (!this.#workTopic)
            throw new Error("workTopic is undefined");
        return this.#workTopic;
    }
    #workLikes;
    get WorkLikes() {
        if (!this.#workLikes)
            throw new Error("workLikes is undefined");
        return this.#workLikes;
    }
    #follow;
    get Follow() {
        if (!this.#follow)
            throw new Error("follow is undefined");
        return this.#follow;
    }
    #topic;
    get Topic() {
    ...
    get WorkImage() {
        if (!this.#workImage)
            throw new Error("workImage is undefined");
