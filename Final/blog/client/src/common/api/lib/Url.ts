...
export const GET_WORK_RESPONSE_AUTHOR_URL = `${
  import.meta.env.VITE_EXTERNAL_API_URL
}/work_resp_author/`;
export const CREATE_FOLLOW_URL = `${
  import.meta.env.VITE_EXTERNAL_API_URL
}/follow/new`;
...
export const GET_WORK_LIKE_URL = `${
  import.meta.env.VITE_EXTERNAL_API_URL
}/work_like/`;
export const NEW_PROFILE_URL = `${
  import.meta.env.VITE_EXTERNAL_API_URL
}/profile/new`;
export const UPDATE_PROFILE_URL = `${
  import.meta.env.VITE_EXTERNAL_API_URL
}/profile/update`;
export const GET_MOST_POP_AUTHORS_URL = `${
  import.meta.env.VITE_EXTERNAL_API_URL
}/profile_popular`;
